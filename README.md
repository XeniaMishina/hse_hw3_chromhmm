...
4 | Weak transcribed | <ul><li> наиболее выражен в H3K9me3, H3K36me3, менее выражен в H3K79me2 </li><li> чаще попадает на RefSeqGene, RefSeqTES, реже на RefSeqExon </li> | ![Image](https://github.com/XeniaMishina/hse_hw3_chromhmm/blob/main/screens/4.png)
...
6 | Weak transcribed | <ul><li> наиболее выражен в H3K79me2, менее выражен в H4K20me1, H3K36me3 </li><li> чаще попадает на RefSeqGene </li> | ![Image](https://github.com/XeniaMishina/hse_hw3_chromhmm/blob/main/screens/6.png)
...
8 | Weak/strong enhancer | <ul><li> наиболее выражен в H3K4me1 </li><li> чаще попадает на RefSeqTES, RefSeqGene, реже на laminB1lads(участок репрессированного гетерохроматима) </li> | ![Image](https://github.com/XeniaMishina/hse_hw3_chromhmm/blob/main/screens/8.png)
9 | Weak enhancer | <ul><li> наиболее выражен в H3K4me1, менее выражен в H3K4me2, H3K27ac, H3K9ac </li><li> чаще попадает на RefSeqTES, реже на RefSeqGene, RefSeqExon </li> | ![Image](https://github.com/XeniaMishina/hse_hw3_chromhmm/blob/main/screens/9.png)
10 | Strong enhancer | <ul><li> наиболее выражен в H3K4me1, H3K4me2, H3K4me3, H3K27ac, H3K9ac </li><li> чаще попадает на RefSeqTES, RefSeqTSS2Kb, реже на RefSeqGene, RefSeqExon </li> | ![Image](https://github.com/XeniaMishina/hse_hw3_chromhmm/blob/main/screens/10.png)
11 | Active Promoter | <ul><li> наиболее выражен в H3K4me2, H3K4me3, H3K27ac, H3K9ac </li><li> чаще попадает на CpGIslands, RefSeqExon, RefSeqTSS и RefSeqTSS2Kb, реже на  RefSeqTES </li> | ![Image](https://github.com/XeniaMishina/hse_hw3_chromhmm/blob/main/screens/11.png)
